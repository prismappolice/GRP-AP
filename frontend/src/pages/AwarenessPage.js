  ...
  return (
    <div className="min-h-screen pt-12 bg-[#F8FAFC] pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {lightboxOpen && (
          <div
            className="fixed inset-0 z-[1300] flex items-center justify-center bg-white/90 backdrop-blur-sm py-4 overflow-y-auto"
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3" onClick={e => e.stopPropagation()}>
              <img
                ...
                className="max-h-[80vh] max-w-[90vw] rounded-2xl shadow-2xl object-contain border-4 border-black"
              />
              {/* Download Button below image in popup */}
              <a
                href={awarenessPosterSrc}
                download
                className="mt-4 bg-[#2563EB] hover:bg-[#1e40af] text-white font-semibold py-2 px-5 rounded-lg shadow transition-colors duration-200 flex items-center gap-2"
                title="Download Awareness Poster"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v12m0 0l-4-4m4 4l4-4m-9 7h14" /></svg>
                Download
              </a>
            </div>
          </div>
                         ...
                         <ul className={listClassName}>
                          ...
                          <li>• If your device is lost or stolen:
                            <ul className="list-disc ml-5 mt-1 space-y-1 text-sm sm:text-[15px] leading-6">
                              ...
                              <li className="flex flex-wrap items-baseline gap-x-1">– Block Your IMEI through <a href="https://www.ceir.gov.in/" className="text-[#2563EB] underline whitespace-nowrap" target="_blank" rel="noopener noreferrer">ceir.sancharsaathi.gov.in</a> Portal.</li>
                            </ul>
                          </li>
                        </ul>
                    </Card>
