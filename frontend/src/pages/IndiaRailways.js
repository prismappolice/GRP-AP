...
export default function IndiaRailways() {
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-16">
      {/* Hero Section */}
      <section className="relative z-0 flex flex-col items-center justify-center overflow-hidden h-[480px] mb-12">
        <div
          className="absolute inset-0 bg-cover bg-center"
             style={{ backgroundImage: 'url(/railway.png)', filter: 'brightness(1.2)' }}
        />
          <div className="absolute inset-0 bg-black bg-opacity-40" />
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center text-white h-full flex flex-col justify-center items-center">
      ...
      <section className="max-w-7xl mx-auto px-4 mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <p className="text-base text-[#475569]">For feedback, lost & found, or complaints, visit <a href="https://railmadad.indianrailways.gov.in/" target="_blank" rel="noopener noreferrer" className="text-[#2563EB] underline">Rail Madad</a>.</p>
          </Card>
        </div>
      </section>
    </div>
