...
export const DEFAULT_STATIC_PAGE_CONTENT = {
  home: {
    ...
    dgpSignature: 'Sri K. Harish Kumar Gupta, I.P.S., Director General of Police, Andhra Pradesh',
  },
  about: {
    eyebrow: 'ABOUT US',
    ...
    grpPoints: [
      ...
      'Handles criminal cases under BNS and BNSS',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Bharatiya Nyaya Sanhita (BNS): For criminal investigations',
          'Bharatiya Nagarik Suraksha Sanhita (BNSS): For procedural matters',
        ],
      },
      {
