...
export const Header = () => {
  ...
  React.useEffect(() => {
    ...
    fetchUnassigned();
    const interval = setInterval(fetchUnassigned, 15000);
  ...
  return (
    <header ref={menuRef} className="fixed top-0 left-0 right-0 w-full z-30 bg-white border-b border-gray-200 shadow-sm">
        ...
        <div className="flex justify-between items-center h-20 lg:h-[76px] xl:h-20">
          ...
          <div className="hidden lg:flex items-center gap-0.5 xl:gap-4">
            ...
            {effectiveIsAdmin && (
              <button
                type="button"
                onClick={(e) => { e.stopPropagation(); navigate('/admin-complaints?unassigned=1'); }}
                className="relative inline-flex items-center justify-center w-9 h-9 rounded-full hover:bg-[#EFF6FF] transition-colors cursor-pointer"
              ...
              >
                ...
                {unassignedCount > 0 && (
                  <>
                    ...
                    <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 rounded-full bg-[#DC2626] text-white text-[10px] font-bold flex items-center justify-center leading-none pointer-events-none">
